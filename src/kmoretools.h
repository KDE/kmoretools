 ...
 *
 */
class KMORETOOLS_EXPORT KMoreTools
{
 ...
 */
class KMORETOOLS_EXPORT KMoreToolsService
{
 ...
 */
class KMORETOOLS_EXPORT KMoreToolsMenuBuilder
{
    friend class KMoreToolsPrivate;
    friend class KMoreTools;
 ...
 */
class KMORETOOLS_EXPORT KMoreToolsMenuItem
{
